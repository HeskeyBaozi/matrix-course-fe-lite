...
import DiscussionsTable from '@/routes/OneAssignment/Programming/Description/DiscussionsTable';
import { IDiscussionItem, IProgrammingConfig, IRanksItem } from '@/types/api';
